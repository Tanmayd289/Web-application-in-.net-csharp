<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Co_ordinator_LOAD.aspx.cs" Inherits="St.Clair.Co_ordinator_LOAD" %>
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    <div class="container-fluid">
                                                            ...
                                                            <asp:UpdatePanel ID="UpdatePanelService" runat="server" UpdateMode="Conditional">
                                                                <ContentTemplate>
                                                                    <asp:GridView ID="gridService" CssClass="col-md-8" AutoGenerateColumns="false" AutoPostBack="True" runat="server" CellPadding="12" ForeColor="#333333"
                                                                        GridLines="None" AllowPaging="True" Style="max-width: 99.666667%;" PageSize="3" OnPageIndexChanging="gridService_PageIndexChanging">
                                    ...
                                    <div class="card-body p-0">
                                        <div class="d-md-flex">
                                            <div class="p-1 flex-fill" style="overflow: hidden; height: 390px;">
                                                <!-- Map will be created here -->
                                                <div id="world-map-markers2" style="height: 360px; overflow: hidden">
                                                    <div class="map">
                        ...
                        <div class="row">
                            <div class="col-md-8" style="flex: none; max-width: none;">
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title">Request's by CAE</h3>
                                    ...
                                    <div class="card-body p-0">
                                        <div class="d-md-flex">
                                            <div class="p-1 flex-fill" style="overflow: hidden; height: 390px;">
                                                <!-- Map will be created here -->
                                                <div id="world-map-markers4" style="height: 360px; overflow: hidden">
                                                    <div class="map">
                                                        ...
                                                        <a href="../adminIndex.aspx">Back </a>| Service Master  
                                                            ...
                                                            <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                                                                <ContentTemplate>
                                                                    <asp:GridView ID="GridView3" CssClass="col-md-8" AutoGenerateColumns="false" AutoPostBack="True" runat="server" CellPadding="12" ForeColor="#333333"
                                                                        GridLines="None" AllowPaging="True" Style="max-width: 99.666667%;" PageSize="3" OnPageIndexChanging="gridService_PageIndexChanging">
                                                                        <%--Caption="Current Program Chart" CaptionAlign="Top"--%>
                        ...
                        <div class="row">
                            <div class="col-md-8" style="flex: none; max-width: none;">
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title">Request's by ProgramChair</h3>
                                    ...
                                    <div class="card-body p-0">
                                        <div class="d-md-flex">
                                            <div class="p-1 flex-fill" style="overflow: hidden; height: 390px;">
                                                <!-- Map will be created here -->
                                                <div id="world-map-markers5" style="height: 360px; overflow: hidden">
                                                    <div class="map">
                                                        ...
                                                        <a href="../adminIndex.aspx">Back </a>| Service Master  
                                                            ...
                                                            <asp:UpdatePanel ID="UpdatePanel3" runat="server" UpdateMode="Conditional">
                                                                <ContentTemplate>
                                                                    <asp:GridView ID="GridView4" CssClass="col-md-8" AutoGenerateColumns="false" AutoPostBack="True" runat="server" CellPadding="12" ForeColor="#333333"
                                                                        GridLines="None" AllowPaging="True" Style="max-width: 99.666667%;" PageSize="3" OnPageIndexChanging="gridService_PageIndexChanging">
                                                                        <%--Caption="Current Program Chart" CaptionAlign="Top"--%>
                    ...
                    <div class="card-body p-0">
                        <br />
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:Label ID="Label6" runat="server" Text="Delivery Variations Modified:" Style="color: #fdc82f; font-size: 15px; resize: vertical; position: absolute;"></asp:Label>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <asp:CheckBox ID="CheckBox1" Text="Standard" runat="server" AutoPostBack="true" EnableViewState="True" OnCheckedChanged="CheckBox1_CheckedChanged1" />
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:CheckBox ID="CheckBox2" Text="Fast Track" runat="server" EnableViewState="True" AutoPostBack="true" OnCheckedChanged="CheckBox2_CheckedChanged" />

                        <asp:CheckBox ID="CheckBox7" Text="Accelerated" runat="server" EnableViewState="True" AutoPostBack="true" OnCheckedChanged="CheckBox7_CheckedChanged2" />


                        <br />
                        <br />
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:Label ID="Label7" runat="server" Style="color: #fdc82f; font-size: 15px;" Text="Total Lab + Lecture Hours:"></asp:Label>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:CheckBox ID="CheckBox3" Text="Standard" runat="server" EnableViewState="true" OnCheckedChanged="CheckBox3_CheckedChanged" AutoPostBack="true" />
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:CheckBox ID="CheckBox4" Text="Fast Track" runat="server" EnableViewState="True" OnCheckedChanged="CheckBox4_CheckedChanged" AutoPostBack="true" />
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:CheckBox ID="CheckBox10" Text="Accelerated" runat="server" EnableViewState="True" OnCheckedChanged="CheckBox10_CheckedChanged1" AutoPostBack="true" />
                        <br />
                        <br />

                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                   
                    <asp:Label ID="Label9" runat="server" Text="Field hours/work simulation supervised:" Style="color: #fdc82f; font-size: 15px;"></asp:Label>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        
                      
                    <asp:CheckBox ID="CheckBox8" Text="Standard" runat="server" EnableViewState="true" OnCheckedChanged="CheckBox8_CheckedChanged" AutoPostBack="true" />
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:CheckBox ID="CheckBox9" Text="Fast Track" runat="server" EnableViewState="True" OnCheckedChanged="CheckBox9_CheckedChanged" AutoPostBack="true" />
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:CheckBox ID="CheckBox11" Text="Accelerated" runat="server" EnableViewState="True" OnCheckedChanged="CheckBox11_CheckedChanged1" AutoPostBack="true" />
                        <br />
                        <br />
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                         <asp:Label ID="Label1" runat="server" Text="Field hours unsupervised:" Style="color: #fdc82f; font-size: 15px;"></asp:Label>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                       
                    <asp:CheckBox ID="CheckBox5" Text="Standard" runat="server" EnableViewState="true" OnCheckedChanged="CheckBox5_CheckedChanged1" AutoPostBack="true" />
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:CheckBox ID="CheckBox6" Text="Fast Track" runat="server" EnableViewState="True" OnCheckedChanged="CheckBox6_CheckedChanged1" AutoPostBack="true" />
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:CheckBox ID="CheckBox12" Text="Accelerated" runat="server" EnableViewState="True" OnCheckedChanged="CheckBox12_CheckedChanged" AutoPostBack="true" />
                    ...
                    <div class="box-cell box2">
                          <br />
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:Label ID="Label2" runat="server" Text="Pre/Co-Requisite List(Reviewed and attached):" Style="color: #fdc82f; font-size: 15px;"></asp:Label>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                       
                    <asp:CheckBox ID="CheckBox13" Text="Yes" runat="server" EnableViewState="true" OnCheckedChanged="CheckBox13_CheckedChanged" AutoPostBack="true" />
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:CheckBox ID="CheckBox14" Text="No" runat="server" EnableViewState="True" OnCheckedChanged="CheckBox14_CheckedChanged" AutoPostBack="true" />
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:CheckBox ID="CheckBox15" Text="N/A" runat="server" EnableViewState="True" OnCheckedChanged="CheckBox15_CheckedChanged" AutoPostBack="true" />


                        <br />
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:Label ID="Label3" runat="server" Text="Program Mapping Attached (check one):" Style="color: #fdc82f; font-size: 15px;"></asp:Label>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                       
                    <asp:CheckBox ID="CheckBox16" Text="Yes" runat="server" EnableViewState="true" OnCheckedChanged="CheckBox16_CheckedChanged" AutoPostBack="true" />
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:CheckBox ID="CheckBox17" Text="No" runat="server" EnableViewState="True" OnCheckedChanged="CheckBox17_CheckedChanged" AutoPostBack="true" />
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:CheckBox ID="CheckBox18" Text="N/A" runat="server" EnableViewState="True" OnCheckedChanged="CheckBox18_CheckedChanged" AutoPostBack="true" />

                        <br />
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:Label ID="Label4" runat="server" Text="PDI Reviewed (check one):" Style="color: #fdc82f; font-size: 15px;"></asp:Label>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                       
                    <asp:CheckBox ID="CheckBox19" Text="Yes" runat="server" EnableViewState="true" OnCheckedChanged="CheckBox19_CheckedChanged" AutoPostBack="true" />
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:CheckBox ID="CheckBox20" Text="No" runat="server" EnableViewState="True" OnCheckedChanged="CheckBox20_CheckedChanged" AutoPostBack="true" />
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:CheckBox ID="CheckBox21" Text="N/A" runat="server" EnableViewState="True" OnCheckedChanged="CheckBox21_CheckedChanged" AutoPostBack="true" />
