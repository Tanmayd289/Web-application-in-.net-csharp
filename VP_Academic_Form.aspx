<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VP_Academic_Form.aspx.cs" Inherits="St.Clair.VP_Academic_Form" %>
                                                            ...
                                                            <asp:UpdatePanel ID="UpdatePanelService" runat="server" UpdateMode="Conditional">
                                                                <ContentTemplate>
                                                                    <asp:GridView ID="gridService" CssClass="col-md-8" AutoGenerateSelectButton="True" AutoGenerateColumns="false" AutoPostBack="True" runat="server" CellPadding="12" ForeColor="#333333"
                                                                        GridLines="None" AllowPaging="True" Style="max-width: 99.666667%;" PageSize="3" OnPageIndexChanging="gridService_PageIndexChanging" OnRowEditing="gridService_RowEditing" OnSelectedIndexChanged="gridService_SelectedIndexChanged" DataKeyNames="ID">
