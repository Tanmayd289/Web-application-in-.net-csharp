<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="CAE_Form.aspx.cs" Inherits="St.Clair.CAE_Form" %>
        ...
        <div class="wrapper">
            ...
            <nav class="main-header navbar navbar-expand navbar-dark">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item d-none d-sm-inline-block">
                        <a href="Login.aspx" class="nav-link">Home</a>
                    </li>
                    <li class="nav-item d-none d-sm-inline-block">
            ...
            <aside class="main-sidebar sidebar-dark-primary elevation-4">
                ...
                <a href="index3.html" class="brand-link">
                    <img src="images/STClair.png" alt="STClair" class="brand-image img-circle elevation-3" style="/* opacity: 2.8; */border-radius: unset;">
                ...
                <div class="sidebar">
                    ...
                    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                        ...
                        <div class="info">
                            <%--<a id="Username" href="#" class="d-block">@Session</a>--%>
              ...
              <%--  <i class="right fas fa-angle-left"></i>--%>
                                ...
                                <%--  <ul class="nav nav-treeview">
                                    <%--<li class="nav-item">
                                        <a href="./CAE_Form.aspx" class="nav-link">
                            ...
                            <li class="nav-item menu-open">
                                <a href="./Request_Form.aspx" class="nav-link active">
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                  ...
                  <small>%</small>
                            ...
                            <div class="col-12 col-sm-6 col-md-3">
                               <%-- <div class="info-box mb-3">
                                    <span class="info-box-icon bg-warning elevation-1"><i class="fas fa-solid fa-flag-checkered"></i></span>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-8">
                                                <p class="text-center">
                                                    <strong>Graph for Request's:</strong>
                                                </p>
                                                ...
                                                <%--  <asp:UpdatePanel ID="UpdatePanelService" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <asp:GridView ID="gridService" runat="server" Visible="true" CssClass="EU_DataTable" AutoGenerateColumns="false" ShowFooter="true" OnRowEditing="gridService_RowEditing" OnRowCreated="gridService_RowCreated" OnRowUpdating="gridService_RowUpdating">
                                                                <Columns>
                                    ...
                                    <div class="card-body p-0">
                                        <div class="d-md-flex">
                                            <div class="p-1 flex-fill" style="overflow: hidden; height: 390px;">
                                                ...
                                                <div id="world-map-markers" style="height: 375px; overflow: hidden">
                                                    <div class="map">
                                                        ...
                                                        <a href="../adminIndex.aspx">Back </a>| Service Master  
                                                            ...
                                                            <asp:UpdatePanel ID="UpdatePanelService" runat="server" UpdateMode="Conditional">
                                                                <ContentTemplate>
                                                                    <asp:GridView ID="gridService" CssClass="col-md-8" AutoGenerateSelectButton="True" AutoGenerateColumns="false" AutoPostBack="True" runat="server" CellPadding="12" ForeColor="#333333"
                                                                        GridLines="None" AllowPaging="True" Style="max-width: 99.666667%;" PageSize="3" OnPageIndexChanging="gridService_PageIndexChanging" OnRowEditing="gridService_RowEditing1" OnSelectedIndexChanged="gridService_SelectedIndexChanged" DataKeyNames="ID">
                                                                        ...
                                                                        <Columns>
                                                                            ...
                                                                            <asp:TemplateField Visible="false">
                                                                                <ItemTemplate>
                                                                                    <asp:Label ID="Transaction_Id" runat="server" Text='<%# Eval("Transaction_Id")%>' />
                                                                                </ItemTemplate>
                                                                            </asp:TemplateField>
                                                                            <%--<asp:BoundField ItemStyle-Width="150px" DataField="Transaction_Id" HeaderText="Transaction_Id" Visible="false" />--%>
                                                                            <asp:BoundField ItemStyle-Width="150px" DataField="Program_Code" HeaderText="Program_Code" />
                                                                            <asp:TemplateField Visible="true" HeaderText="Program Name">
                                                                                <ItemTemplate>
                                                                                    <asp:Label ID="Program_Name" runat="server" Text='<%# Eval("Program_Name")%>' />
                                                                                </ItemTemplate>
                                                                            </asp:TemplateField>
                                                                            <%--<asp:BoundField ItemStyle-Width="150px" DataField="Program_Name" HeaderText="Program_Name" />--%>
                                                                            <asp:BoundField ItemStyle-Width="150px" DataField="MTCU_Code" HeaderText="MTCU_Code" />
                                                                            <asp:BoundField ItemStyle-Width="150px" DataField="UserName" HeaderText="UserName" />
                                                                            <asp:BoundField ItemStyle-Width="150px" DataField="Location_Program_Offered" HeaderText="Location_Program_Offered" />
                                                                            <asp:BoundField ItemStyle-Width="150px" DataField="Request_Date" HeaderText="Request Date" />
                                                                            <%--                                                   <asp:TemplateField >
                                                                                <ItemTemplate>
                                                                                    <asp:Button ID="btn_view" runat="server"  CommandArgument='<%#Container.DataItemIndex%>'
