...
namespace St.Clair
{
    public partial class Co_ordinator_LOAD : System.Web.UI.Page
    {
        ...
        public void BindGrid()
        {
            ...
            DataSet ds = IPL_Commservice.IPL_Data_FetchWithParam("SP_Fetch_Co_ordinator_MASTER", obj);
            gridService.DataSource = ds.Tables[0].Copy();
            gridService.DataBind();
            GridView1.DataSource = ds.Tables[2].Copy();
            GridView1.DataBind();

            GridView3.DataSource = ds.Tables[3].Copy();
            GridView3.DataBind();

            GridView4.DataSource = ds.Tables[4].Copy();
            GridView4.DataBind();
        ...
        protected void Btn_Save_Click1(object sender, EventArgs e)
        {
            ...
            try
            {
                dsinsert = Class1.WebServiceMaster.IPL_Data_FetchWithParam("SP_Insert_Master_DATA_ProgramChair", Para);
            ...
            Response.Redirect("~/ProgramChair_Form.aspx");
        }
        ...
        protected void CheckBox8_CheckedChanged(object sender, EventArgs e)
        {
            ...
            else if (CheckBox8.Checked == false && CheckBox9.Checked == false)
            {
                CheckBox8.Checked = true;
                CheckBox9.Checked = false;
            }
        ...
        protected void CheckBox7_CheckedChanged2(object sender, EventArgs e)
        {

        }

        protected void CheckBox10_CheckedChanged1(object sender, EventArgs e)
        {
