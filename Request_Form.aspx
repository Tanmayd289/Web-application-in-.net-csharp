<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Request_Form.aspx.cs" Inherits="St.Clair.Request_Form" %>
                                                            ...
                                                            <asp:UpdatePanel ID="UpdatePanelService" runat="server" UpdateMode="Conditional">
                                                                <ContentTemplate>
                                                                    <asp:GridView ID="gridService" CssClass="col-md-8"  AutoGenerateColumns="false" AutoPostBack="True" runat="server" CellPadding="12" ForeColor="#333333"
                                                                        GridLines="None" AllowPaging="True" Style="max-width: 99.666667%;" PageSize="1" OnPageIndexChanging="gridService_PageIndexChanging" OnRowEditing="gridService_RowEditing" OnSelectedIndexChanged="gridService_SelectedIndexChanged" DataKeyNames="ID">
                                                                        ...
                                                                        <Columns>
                                                                            ...
                                                                            <asp:BoundField ItemStyle-Width="150px" DataField="Request_Status" HeaderText="Request Status" />
                                                                            <%--                                                   <asp:TemplateField >
                                                                                <ItemTemplate>
